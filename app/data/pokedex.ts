// Code from Pokemon Showdown. Shoutout Smogon and the Showdown people they know what's up.
// Going to break TS here and not interface this because holy crap I'mm looking through how Pokemon Showdown's github does the typing on this stuff
// and it's deep. Not trynna do that right now. I will suffer the reprocussions of not explicitly typing this later I suppose.
export const Pokedex: { [key: string]: any } = {
  bulbasaur: {
    num: 1,
    name: "Bulbasaur",
    types: ["Grass", "Poison"],
